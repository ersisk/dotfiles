...
alias fzflg="fd -I -e log | gum filter --limit 1 --no-sort --fuzzy --placeholder 'Pick a Log' --height 50 --prompt='⚡' | xargs -r -o sieve"
alias fzflgt="fd -I -e log | gum filter --limit 1 --no-sort --fuzzy --placeholder 'Pick a Log' --height 50 --prompt='⚡' | xargs -r -o tail -f | hl -P"
